...
function buildCrypt(): LevelDef {
  ...
  fill(grid, 39, 9, 42, 9);
  fill(grid, 1, 10, 4, 10);
  fill(grid, 39, 10, 42, 10);
  fill(grid, 1, 11, 4, 11);
  fill(grid, 39, 11, 42, 11);
  fill(grid, 1, 12, 4, 12);
  fill(grid, 18, 12, 26, 12);
  fill(grid, 39, 12, 42, 12);
  const map = new TileMap(grid.map((r) => r.join('')));
  ...
  return {
    ...
    map,
    spawn: { x: 2 * TILE, y: 15 * TILE - 28 },
    boxes: [{ x: 6 * TILE, y: 10 * TILE - 28, w: 28, h: 28 }, { x: 6 * TILE, y: 11 * TILE - 28, w: 28, h: 28 }, { x: 6 * TILE, y: 12 * TILE - 28, w: 28, h: 28 }, { x: 6 * TILE, y: 13 * TILE - 28, w: 28, h: 28 }, { x: 6 * TILE, y: 14 * TILE - 28, w: 28, h: 28 }, { x: 6 * TILE, y: 15 * TILE - 28, w: 28, h: 28 }, { x: 7 * TILE, y: 15 * TILE - 28, w: 28, h: 28 }, { x: 8 * TILE, y: 15 * TILE - 28, w: 28, h: 28 }, { x: 9 * TILE, y: 15 * TILE - 28, w: 28, h: 28 }, { x: 10 * TILE, y: 15 * TILE - 28, w: 28, h: 28 }, { x: 11 * TILE, y: 15 * TILE - 28, w: 28, h: 28 }, { x: 12 * TILE, y: 15 * TILE - 28, w: 28, h: 28 }, { x: 12 * TILE, y: 14 * TILE - 28, w: 28, h: 28 }, { x: 16 * TILE, y: 14 * TILE - 28, w: 28, h: 28 }, { x: 15 * TILE, y: 14 * TILE - 28, w: 28, h: 28 }, { x: 14 * TILE, y: 14 * TILE - 28, w: 28, h: 28 }, { x: 13 * TILE, y: 14 * TILE - 28, w: 28, h: 28 }, { x: 13 * TILE, y: 15 * TILE - 28, w: 28, h: 28 }, { x: 14 * TILE, y: 15 * TILE - 28, w: 28, h: 28 }, { x: 15 * TILE, y: 15 * TILE - 28, w: 28, h: 28 }, { x: 16 * TILE, y: 15 * TILE - 28, w: 28, h: 28 }, { x: 28 * TILE, y: 14 * TILE - 28, w: 28, h: 28 }, { x: 29 * TILE, y: 14 * TILE - 28, w: 28, h: 28 }, { x: 30 * TILE, y: 14 * TILE - 28, w: 28, h: 28 }, { x: 33 * TILE, y: 14 * TILE - 28, w: 28, h: 28 }, { x: 32 * TILE, y: 14 * TILE - 28, w: 28, h: 28 }, { x: 31 * TILE, y: 14 * TILE - 28, w: 28, h: 28 }, { x: 32 * TILE, y: 15 * TILE - 28, w: 28, h: 28 }, { x: 31 * TILE, y: 15 * TILE - 28, w: 28, h: 28 }, { x: 30 * TILE, y: 15 * TILE - 28, w: 28, h: 28 }, { x: 29 * TILE, y: 15 * TILE - 28, w: 28, h: 28 }, { x: 28 * TILE, y: 15 * TILE - 28, w: 28, h: 28 }, { x: 11 * TILE, y: 14 * TILE - 28, w: 28, h: 28 }, { x: 10 * TILE, y: 14 * TILE - 28, w: 28, h: 28 }, { x: 9 * TILE, y: 14 * TILE - 28, w: 28, h: 28 }, { x: 7 * TILE, y: 14 * TILE - 28, w: 28, h: 28 }, { x: 7 * TILE, y: 13 * TILE - 28, w: 28, h: 28 }, { x: 7 * TILE, y: 12 * TILE - 28, w: 28, h: 28 }, { x: 7 * TILE, y: 11 * TILE - 28, w: 28, h: 28 }, { x: 7 * TILE, y: 10 * TILE - 28, w: 28, h: 28 }, { x: 7 * TILE, y: 9 * TILE - 28, w: 28, h: 28 }, { x: 6 * TILE, y: 9 * TILE - 28, w: 28, h: 28 }, { x: 6 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 6 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 6 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 6 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 6 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 6 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 6 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 7 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 7 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 7 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 7 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 7 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 7 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 7 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 9 * TILE, y: 12 * TILE - 28, w: 28, h: 28 }, { x: 9 * TILE, y: 13 * TILE - 28, w: 28, h: 28 }, { x: 8 * TILE, y: 14 * TILE - 28, w: 28, h: 28 }, { x: 8 * TILE, y: 13 * TILE - 28, w: 28, h: 28 }, { x: 8 * TILE, y: 12 * TILE - 28, w: 28, h: 28 }, { x: 8 * TILE, y: 10 * TILE - 28, w: 28, h: 28 }, { x: 8 * TILE, y: 9 * TILE - 28, w: 28, h: 28 }, { x: 8 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 8 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 8 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 8 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 8 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 8 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 8 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 10 * TILE, y: 13 * TILE - 28, w: 28, h: 28 }, { x: 10 * TILE, y: 12 * TILE - 28, w: 28, h: 28 }, { x: 9 * TILE, y: 9 * TILE - 28, w: 28, h: 28 }, { x: 9 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 9 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 9 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 9 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 9 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 9 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 9 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 10 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 10 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 10 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 10 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 10 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 10 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 11 * TILE, y: 13 * TILE - 28, w: 28, h: 28 }, { x: 12 * TILE, y: 13 * TILE - 28, w: 28, h: 28 }, { x: 15 * TILE, y: 13 * TILE - 28, w: 28, h: 28 }, { x: 16 * TILE, y: 13 * TILE - 28, w: 28, h: 28 }, { x: 31 * TILE, y: 13 * TILE - 28, w: 28, h: 28 }, { x: 32 * TILE, y: 13 * TILE - 28, w: 28, h: 28 }, { x: 33 * TILE, y: 13 * TILE - 28, w: 28, h: 28 }, { x: 33 * TILE, y: 12 * TILE - 28, w: 28, h: 28 }, { x: 32 * TILE, y: 12 * TILE - 28, w: 28, h: 28 }, { x: 31 * TILE, y: 12 * TILE - 28, w: 28, h: 28 }, { x: 30 * TILE, y: 12 * TILE - 28, w: 28, h: 28 }, { x: 29 * TILE, y: 12 * TILE - 28, w: 28, h: 28 }, { x: 28 * TILE, y: 12 * TILE - 28, w: 28, h: 28 }, { x: 16 * TILE, y: 12 * TILE - 28, w: 28, h: 28 }, { x: 14 * TILE, y: 13 * TILE - 28, w: 28, h: 28 }, { x: 13 * TILE, y: 13 * TILE - 28, w: 28, h: 28 }, { x: 11 * TILE, y: 12 * TILE - 28, w: 28, h: 28 }, { x: 12 * TILE, y: 12 * TILE - 28, w: 28, h: 28 }, { x: 13 * TILE, y: 12 * TILE - 28, w: 28, h: 28 }, { x: 14 * TILE, y: 12 * TILE - 28, w: 28, h: 28 }, { x: 15 * TILE, y: 12 * TILE - 28, w: 28, h: 28 }, { x: 10 * TILE, y: 11 * TILE - 28, w: 28, h: 28 }, { x: 12 * TILE, y: 11 * TILE - 28, w: 28, h: 28 }, { x: 14 * TILE, y: 11 * TILE - 28, w: 28, h: 28 }, { x: 16 * TILE, y: 11 * TILE - 28, w: 28, h: 28 }, { x: 28 * TILE, y: 11 * TILE - 28, w: 28, h: 28 }, { x: 29 * TILE, y: 11 * TILE - 28, w: 28, h: 28 }, { x: 30 * TILE, y: 11 * TILE - 28, w: 28, h: 28 }, { x: 31 * TILE, y: 11 * TILE - 28, w: 28, h: 28 }, { x: 32 * TILE, y: 11 * TILE - 28, w: 28, h: 28 }, { x: 32 * TILE, y: 10 * TILE - 28, w: 28, h: 28 }, { x: 31 * TILE, y: 10 * TILE - 28, w: 28, h: 28 }, { x: 30 * TILE, y: 10 * TILE - 28, w: 28, h: 28 }, { x: 29 * TILE, y: 10 * TILE - 28, w: 28, h: 28 }, { x: 28 * TILE, y: 10 * TILE - 28, w: 28, h: 28 }, { x: 16 * TILE, y: 9 * TILE - 28, w: 28, h: 28 }, { x: 15 * TILE, y: 9 * TILE - 28, w: 28, h: 28 }, { x: 14 * TILE, y: 9 * TILE - 28, w: 28, h: 28 }, { x: 13 * TILE, y: 9 * TILE - 28, w: 28, h: 28 }, { x: 15 * TILE, y: 10 * TILE - 28, w: 28, h: 28 }, { x: 16 * TILE, y: 10 * TILE - 28, w: 28, h: 28 }, { x: 15 * TILE, y: 11 * TILE - 28, w: 28, h: 28 }, { x: 13 * TILE, y: 11 * TILE - 28, w: 28, h: 28 }, { x: 11 * TILE, y: 11 * TILE - 28, w: 28, h: 28 }, { x: 9 * TILE, y: 11 * TILE - 28, w: 28, h: 28 }, { x: 8 * TILE, y: 11 * TILE - 28, w: 28, h: 28 }, { x: 9 * TILE, y: 10 * TILE - 28, w: 28, h: 28 }, { x: 10 * TILE, y: 10 * TILE - 28, w: 28, h: 28 }, { x: 14 * TILE, y: 10 * TILE - 28, w: 28, h: 28 }, { x: 13 * TILE, y: 10 * TILE - 28, w: 28, h: 28 }, { x: 12 * TILE, y: 10 * TILE - 28, w: 28, h: 28 }, { x: 11 * TILE, y: 10 * TILE - 28, w: 28, h: 28 }, { x: 11 * TILE, y: 9 * TILE - 28, w: 28, h: 28 }, { x: 10 * TILE, y: 9 * TILE - 28, w: 28, h: 28 }, { x: 10 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 11 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 11 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 11 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 11 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 11 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 11 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 12 * TILE, y: 9 * TILE - 28, w: 28, h: 28 }, { x: 12 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 12 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 12 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 12 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 12 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 12 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 11 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 12 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 13 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 14 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 30 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 29 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 28 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 27 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 26 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 25 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 24 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 23 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 22 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 21 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 20 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 19 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 18 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 17 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 16 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 15 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 14 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 13 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 13 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 13 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 14 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 15 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 16 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 28 * TILE, y: 9 * TILE - 28, w: 28, h: 28 }, { x: 29 * TILE, y: 9 * TILE - 28, w: 28, h: 28 }, { x: 30 * TILE, y: 9 * TILE - 28, w: 28, h: 28 }, { x: 31 * TILE, y: 9 * TILE - 28, w: 28, h: 28 }, { x: 31 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 30 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 29 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 28 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 27 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 26 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 25 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 24 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 23 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 22 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 21 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 20 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 19 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 18 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 17 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 13 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 14 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 15 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 16 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 17 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 18 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 19 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 20 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 21 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 22 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 23 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 24 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 25 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 26 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 27 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 28 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 29 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 30 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 31 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 21 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 20 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 19 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 18 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 17 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 16 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 15 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 14 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 13 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 13 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 14 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 15 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 16 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 17 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 18 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 19 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 22 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 23 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 24 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 25 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 26 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 27 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 28 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 29 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 30 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 31 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 24 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 23 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 22 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 21 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 20 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 14 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 15 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 16 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 25 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 26 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 27 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 28 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 29 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 30 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 31 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 33 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 32 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 31 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 30 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 29 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 28 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 27 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 26 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 25 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 24 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 23 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 22 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 21 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 20 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 19 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 18 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 17 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 15 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 16 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 17 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 18 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 19 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 20 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 21 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 22 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 23 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 24 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 25 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 26 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 27 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 28 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 29 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 30 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 31 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 37 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 36 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 35 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 34 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 33 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 31 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 32 * TILE, y: 2 * TILE - 28, w: 28, h: 28 }, { x: 32 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 33 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 37 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 37 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 36 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 35 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 34 * TILE, y: 3 * TILE - 28, w: 28, h: 28 }, { x: 34 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 35 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 36 * TILE, y: 4 * TILE - 28, w: 28, h: 28 }, { x: 37 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 36 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 35 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 34 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 33 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 32 * TILE, y: 5 * TILE - 28, w: 28, h: 28 }, { x: 32 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 33 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 34 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 35 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 37 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 37 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 37 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 37 * TILE, y: 9 * TILE - 28, w: 28, h: 28 }, { x: 37 * TILE, y: 10 * TILE - 28, w: 28, h: 28 }, { x: 37 * TILE, y: 11 * TILE - 28, w: 28, h: 28 }, { x: 37 * TILE, y: 12 * TILE - 28, w: 28, h: 28 }, { x: 37 * TILE, y: 13 * TILE - 28, w: 28, h: 28 }, { x: 37 * TILE, y: 14 * TILE - 28, w: 28, h: 28 }, { x: 37 * TILE, y: 15 * TILE - 28, w: 28, h: 28 }, { x: 36 * TILE, y: 15 * TILE - 28, w: 28, h: 28 }, { x: 35 * TILE, y: 15 * TILE - 28, w: 28, h: 28 }, { x: 33 * TILE, y: 15 * TILE - 28, w: 28, h: 28 }, { x: 34 * TILE, y: 15 * TILE - 28, w: 28, h: 28 }, { x: 36 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 36 * TILE, y: 6 * TILE - 28, w: 28, h: 28 }, { x: 35 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 34 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 32 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 33 * TILE, y: 7 * TILE - 28, w: 28, h: 28 }, { x: 35 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 36 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 36 * TILE, y: 9 * TILE - 28, w: 28, h: 28 }, { x: 36 * TILE, y: 10 * TILE - 28, w: 28, h: 28 }, { x: 36 * TILE, y: 11 * TILE - 28, w: 28, h: 28 }, { x: 36 * TILE, y: 12 * TILE - 28, w: 28, h: 28 }, { x: 36 * TILE, y: 13 * TILE - 28, w: 28, h: 28 }, { x: 36 * TILE, y: 14 * TILE - 28, w: 28, h: 28 }, { x: 35 * TILE, y: 14 * TILE - 28, w: 28, h: 28 }, { x: 35 * TILE, y: 13 * TILE - 28, w: 28, h: 28 }, { x: 35 * TILE, y: 12 * TILE - 28, w: 28, h: 28 }, { x: 35 * TILE, y: 11 * TILE - 28, w: 28, h: 28 }, { x: 35 * TILE, y: 10 * TILE - 28, w: 28, h: 28 }, { x: 35 * TILE, y: 9 * TILE - 28, w: 28, h: 28 }, { x: 34 * TILE, y: 14 * TILE - 28, w: 28, h: 28 }, { x: 34 * TILE, y: 13 * TILE - 28, w: 28, h: 28 }, { x: 34 * TILE, y: 12 * TILE - 28, w: 28, h: 28 }, { x: 34 * TILE, y: 11 * TILE - 28, w: 28, h: 28 }, { x: 34 * TILE, y: 10 * TILE - 28, w: 28, h: 28 }, { x: 34 * TILE, y: 9 * TILE - 28, w: 28, h: 28 }, { x: 34 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 33 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 32 * TILE, y: 8 * TILE - 28, w: 28, h: 28 }, { x: 32 * TILE, y: 9 * TILE - 28, w: 28, h: 28 }, { x: 33 * TILE, y: 11 * TILE - 28, w: 28, h: 28 }, { x: 33 * TILE, y: 10 * TILE - 28, w: 28, h: 28 }, { x: 33 * TILE, y: 9 * TILE - 28, w: 28, h: 28 }, { x: 28 * TILE, y: 13 * TILE - 28, w: 28, h: 28 }, { x: 29 * TILE, y: 13 * TILE - 28, w: 28, h: 28 }, { x: 30 * TILE, y: 13 * TILE - 28, w: 28, h: 28 }],
    devices: [],
    buttons: [button(27, 11, 0)],
    phase: [...phaseBlocks(0, 27, 11, 27, 11, true), ...phaseBlocks(0, 26, 11, 26, 11, true), ...phaseBlocks(0, 25, 11, 25, 11, true), ...phaseBlocks(0, 24, 11, 24, 11, true), ...phaseBlocks(0, 23, 11, 23, 11, true), ...phaseBlocks(0, 22, 11, 22, 11, true), ...phaseBlocks(0, 21, 11, 21, 11, true), ...phaseBlocks(0, 20, 11, 20, 11, true), ...phaseBlocks(0, 19, 11, 19, 11, true), ...phaseBlocks(0, 18, 11, 18, 11, true), ...phaseBlocks(0, 17, 11, 17, 11, true)],
    hazards: [],
    hazardsInverted: [],
    springs: [],
    exit: { x: 22.5 * TILE, y: 15 * TILE - 26, r: 22 },
  };
}
